...
1- KriaCpp: projet c++ qui contient la logique d'appel à llama-cpp , tout en assurant l'interopérabilité JNI.
2- KriaFront: projet kotlin qui appelle la librairie generé par llama cpp, pour efectuer des predictions depuis des modèles LLM local au format gguf.
